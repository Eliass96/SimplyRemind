...
pug_html = pug_html + "\u003Coutput class=\"alta d-flex align-items-stretch justify-content-center flex-direction-row\"\u003E\u003Carticle class=\"todas_las_notas\"\u003E\u003C\u002Farticle\u003E\u003C\u002Foutput\u003E\u003Col" + (" class=\"todas_las_notas\""+pug_attr("ol", true, true, false)) + "\u003E\u003Cli" + (" class=\"todas_las_notas\""+pug_attr("li", true, true, false)) + "\u003E\u003C!--input(type='color' value='' #{nota.color})--\u003E\u003Ca href=\"#\"\u003E" + (pug_escape(null == (pug_interp = nota.titulo) ? "" : pug_interp)) + "\u003C\u002Fa\u003E\u003Cbutton class=\"but_eliminar_nota_lista\" type=\"button\"\u003E\u003Cimg src=\"icon\u002Ftrash.svg\" alt=\"Eliminar Nota\"\u002F\u003E\u003C\u002Fbutton\u003E\u003Cbutton class=\"but_duplicar_nota_lista\" type=\"button\"\u003E\u003Cimg src=\"icon\u002Fclone.svg\" alt=\"Duplicar Nota\"\u002F\u003E\u003C\u002Fbutton\u003E\u003C\u002Fli\u003E\u003C\u002Fol\u003E";
      }
  } else {
    var $$l = 0;
